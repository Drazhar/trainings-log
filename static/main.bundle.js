 ...
 * http://polymer.github.io/PATENTS.txt
 */
const f=new WeakMap,y=t=>"function"==typeof t&&f.has(t),g={},S={};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
class{handleAttributeExpressions(t,e,s,i){const n=e[0];if("."===n){return new V(t,e.slice(1),s).parts}if("@"===n)return[new U(t,e.slice(1),i.eventContext)];if("?"===n)return[new E(t,e.slice(1),s)];return new C(t,e,s).parts}handleTextExpression(t){return new A(t)}};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
